...
// import { Check, Code2, Loader2, Sparkles, Wand2 } from "lucide-react";
...
//               AI code explainer
//             </div>
//             <h1>Understand snippets faster.</h1>
//           </div>
...
//           <form className="editorPane" onSubmit={handleSubmit}>
...
//                 <button
//                   type="button"
//                   className={language === "javascript" ? "selected" : ""}
...
//                   onChange={(event) => setIncludeOptimization(event.target.checked)}
//                 />
//                 Optimize
//               </label>
//             </div>
...
//               <button className="primaryButton" disabled={loading || !code.trim()}>
...
//                 Explanation
//               </div>
//               <p className="explanation">{activeResult.explanation}</p>
...
//                 </div>
//               </div>
//               <p className="complexityReason">{activeResult.complexity.reason}</p>
//             </article>

//             <CodePanel code={activeResult.originalCode} annotations={activeResult.annotations} />
